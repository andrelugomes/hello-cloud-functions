package com.github.andrelugomes.v3.infrastructure;

import com.github.andrelugomes.v3.infrastructure.adapter.ElasticsearchMerchantAdapter;
...
import com.github.andrelugomes.v3.domain.Indexer;
...
public class FunctionEntrypoint implements BackgroundFunction<Event> {
    ...
    public void accept(Event event, Context context) throws IOException, InterruptedException {
        ...
        var merchantParserAdapter = new JacksonEventParserAdapter();
        var indexer = new Indexer(merchantAdapter, merchantParserAdapter);
