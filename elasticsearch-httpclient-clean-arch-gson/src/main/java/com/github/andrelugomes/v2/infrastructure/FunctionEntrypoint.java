package com.github.andrelugomes.v2.infrastructure;

import com.github.andrelugomes.v2.infrastructure.adapter.ElasticsearchMerchantAdapter;
import com.github.andrelugomes.v2.infrastructure.adapter.GsonEventParserAdapter;
import com.github.andrelugomes.v2.domain.Indexer;
...
public class FunctionEntrypoint implements BackgroundFunction<Event> {
    ...
    public void accept(Event event, Context context) throws IOException, InterruptedException {
        ...
        var merchantParserAdapter = new GsonEventParserAdapter();
