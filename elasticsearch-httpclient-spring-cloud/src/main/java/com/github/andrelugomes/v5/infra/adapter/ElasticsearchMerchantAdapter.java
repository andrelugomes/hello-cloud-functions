package com.github.andrelugomes.v5.infra.adapter;

import com.github.andrelugomes.v5.domain.usecase.indexing.gateway.MerchantGateway;
import com.github.andrelugomes.v5.infra.adapter.exception.ResponseException;
...
public class ElasticsearchMerchantAdapter implements MerchantGateway {
    ...
    private HttpRequest getRequest(HttpRequest.Builder httpRequest, final String merchantId) {
        httpRequest = httpRequest.uri(URI.create(elasticEndpoint + MERCHANTS_DOC + merchantId));
